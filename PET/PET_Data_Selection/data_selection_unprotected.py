...
def process_folder(folder_path):
    ...
    for file_path in csv_files:
        ...
        try:
            ...
            # Convert to string first, then lowercase, to handle NaN values
            ...
            # Start: first occurrence of Lane_ID == 6469
            ...
            # End: last occurrence of Lane_ID == 5743
            ...
            # ==========================================
            # 5.5 Additional step: clean ="..." format from data
            # ==========================================
...
if __name__ == "__main__":
    ...
    target_folder = '/Users/xinweiyang/Desktop/TTC_224_0811/HB'
